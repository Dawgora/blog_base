defmodule HomepageWeb.PostLiveTest do
  use HomepageWeb.ConnCase

  import Phoenix.LiveViewTest
  import Homepage.PostsFixtures

  @create_attrs %{body: "some body", context: "some context", published: true, slug: "some slug", title: "some title"}
  ...
  @invalid_attrs %{body: nil, context: nil, published: false, slug: nil, title: nil}
